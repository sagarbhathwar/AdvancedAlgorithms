...
public:
    ...
    static Matrix<T> recursive_matrix_multiplication(const Matrix<T>& A, const Matrix<T>& B);
...
template <typename T>
Matrix<T> Matrix<T>::recursive_matrix_multiplication(const Matrix<T>& A,const  Matrix<T>& B)
{
    int n = A.n_rows_;
    ...
    else
    {
        ...
        Matrix<T> C00 = recursive_matrix_multiplication(a00, b00) + recursive_matrix_multiplication(a01, b10);
        Matrix<T> C01 = recursive_matrix_multiplication(a00, b01) + recursive_matrix_multiplication(a01, b11);
        Matrix<T> C10 = recursive_matrix_multiplication(a10, b00) + recursive_matrix_multiplication(a11, b01);
        Matrix<T> C11 = recursive_matrix_multiplication(a10, b01) + recursive_matrix_multiplication(a11, b11);
...
int main()
{
    ...
    auto C1 = Matrix<float>::recursive_matrix_multiplication(A, B);
